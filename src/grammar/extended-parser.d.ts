...
export type StartRuleNames = "DateEx";
export interface ParseOptions<T extends StartRuleNames = "DateEx"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"DateEx">>(
  input: string,
  options?: Options,
): any;
